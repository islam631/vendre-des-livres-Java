...
<body>
	...
	<header class="header">
		...
		<div class="header-1">
			...
			<a href="#" class="logo"> <i class="fas fa-book"></i> SAOI STORE
			</a>

			<form action="cherchlv.jsp" method="post" class="search-form">
				<input type="search" name="titreLv" placeholder="search here..."
					id="search-box"> <label for="search-box"
					class="fas fa-search"></label>
			</form>
			<div class="profile-details">
			
				<span class="admin_name" style="font-size: 0.5cm;">client : <jsp:useBean
						id="nomCl" class="Beans.Client_Beans" scope="request"></jsp:useBean>
					<jsp:getProperty property="NOM_CL" name="nomCl" /> <jsp:getProperty
						property="PRENOM_CL" name="nomCl" />
			
				</span>
			</div>
			<button style="font-size: large; text-decoration: none;">
				<a href="PPavantSr.jsp">Diconnecter</a>
			</button>
			<div class="icons">
		...
		<div class="header-2">
			<nav class="navbar">
				<a href="#home">Domicile</a> <a href="#product-preview">Livres
					étrangers</a> <a href="#featured">livres arabes</a>
			</nav>
		</div>
	</header>
	...
	<div class="login-form-container">
		...
		<form action="LoginUtAd" method="post">
			<h3>
				...
				<ul>
					<li><H5>Si vous ï¿½tes un admin donner votre email et mot
							de passe</H5></li>
					<li><h5>le mï¿½me avec les utilisateurs</h5></li>
				</ul>
			</h3>
			<span>email</span> <input type="email" name="email1" class="box"
				placeholder="enter your email" id=""> <span>mot de
				passe</span> <input type="password" name="password1" class="box"
				placeholder="enter your password" id=""> <input
				type="submit" value="sign in" class="btn">
			<p>
				vous n'avez pas de compte ? <a href="CreationCmpCl.jsp	">crï¿½er
					un compte</a>
			</p>
		</form>
	</div>
	...
	out.println("<h1 class='heading'><br><br><br><br><br><br>");
